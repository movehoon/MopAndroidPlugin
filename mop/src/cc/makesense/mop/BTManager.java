...
public class BTManager {
	...
	private static final String NAME = "SiCi";
	...
	private class ConnectedThread extends Thread
	{
		...
		public void write(byte[] buffer)
		{
			try
			{
				...
				Log.i(TAG, new String(buffer, 0, buffer.length));
